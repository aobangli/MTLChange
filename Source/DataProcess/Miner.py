...
class Miner:
    ...
    def download(self, url: str, timeout: int, filename: str, is_a_change: bool = False) -> bool:
        print(f"Request : {url}")
        cold_time = random.uniform(1, 3)
        time.sleep(cold_time)
        ua = UserAgent()
        headers = {
            "User-Agent": ua.random,
            # 'Connection': 'close',
            "cookie": "HSID=A-pT9PWDQMkzhhodU; SSID=AZqDIg--G58GXsmwx; APISID=DOyR5iTHLhwqKxhA/AGZ4oTitM1RKFmUT0; SAPISID=5FRdR8o-KVf8xFet/AuyMGenC9u6OQnSbU; __Secure-1PAPISID=5FRdR8o-KVf8xFet/AuyMGenC9u6OQnSbU; __Secure-3PAPISID=5FRdR8o-KVf8xFet/AuyMGenC9u6OQnSbU; SID=UgjtlJCmQzLJhMc--pIQUsvyqJZZdNQmla66k4K5iSbFo6umB2lBfS0rAyYJxqko_i8QpQ.; __Secure-1PSID=UgjtlJCmQzLJhMc--pIQUsvyqJZZdNQmla66k4K5iSbFo6umy9VMZ2qdQ4roe0iQEOjfzA.; __Secure-3PSID=UgjtlJCmQzLJhMc--pIQUsvyqJZZdNQmla66k4K5iSbFo6umxMlbM0uEiyYz8Hd0dpXAjQ.; gi=0; XSRF_TOKEN=ANR1CjibqWPp6msvAtuoA1733F3khIlJc7P8WLdxfKRgZd2ofnWmvBC8SkL7bYPbd4CIJhwGZcdh"
        }
