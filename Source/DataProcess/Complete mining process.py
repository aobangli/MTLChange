...
def main():
    ...
    #
    # # 10. break batch change file contents into individual change file
    ...
    # # 11. mine change diff using 'Mine file diff.py' file.
    #
    ...
    for filename in tqdm(filenames):
        ...
        with open(os.path.join(change_directory_path, filename), 'r', encoding='utf-8') as input_file:
            for change_json in load_change_jsons(input_file):
                ...
                change_details['languages'].append(change.language_set)

                change_details['avg_score'].append(change.avg_score)
                # break
